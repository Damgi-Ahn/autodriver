#ifndef HYBRID_LOCALIZATION__ESKF__GNSS_UPDATE_HANDLER_HPP_
#define HYBRID_LOCALIZATION__ESKF__GNSS_UPDATE_HANDLER_HPP_
...
#endif // HYBRID_LOCALIZATION__ESKF__GNSS_UPDATE_HANDLER_HPP_
